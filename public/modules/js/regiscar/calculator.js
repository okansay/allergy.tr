// RegiSCAR Score Calculator - Namespace wrapped to avoid conflicts with SCORAD
(function() {
    'use strict';
                        ...
                        ${criterion.options.map(option => `
                            <label class="flex items-center gap-3 p-3 rounded-lg border-2 cursor-pointer transition-all
                                ...
                                <input
                                    ...
                                    name="${criterion.id}"
                                    value="${option.value}"
                                    onchange="handleRegiscarSelection('${criterion.id}', '${option.value}', ${option.points}, ${isOrgan})"
    ...
    window.handleRegiscarSelection = handleSelection;
    window.resetRegiscarScore = resetRegiscarScore;
