<div class="flex flex-col p-4">
    ...
    <nav class="flex flex-col gap-1">
        ...
        <div x-data="{ open: false }">
            ...
            <div
                @click="open = !open"
                :class="(currentRoute === 'desensitization' || currentRoute === 'betalactam-cross-reactivity' || currentRoute === 'skin-test-concentrations' || currentRoute === 'desensitization-protocol-library') ? 'bg-primary/10 text-primary' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'"
                class="flex h-12 items-center gap-4 rounded-lg px-4 cursor-pointer transition-colors"
            >
            ...
            <div x-show="open" x-collapse class="ml-4 mt-1 space-y-1">
                ...
                >
                    ...
                    <p class="text-sm font-medium truncate">Protokol Kütüphanesi</p>
                </a>
            </div>
        </div>
